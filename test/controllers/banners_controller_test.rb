...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { end_time: @banner.end_time, link: @banner.link, position: @banner.position, start_time: @banner.start_time } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { end_time: @banner.end_time, link: @banner.link, position: @banner.position, start_time: @banner.start_time } }
